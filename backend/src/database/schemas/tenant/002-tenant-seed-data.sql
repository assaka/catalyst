...
INSERT INTO email_templates ("id", "store_id", "identifier", "content_type", "variables", "is_active", "sort_order", "attachment_enabled", "attachment_config", "created_at", "updated_at", "is_system", "default_subject", "default_template_content", "default_html_content") VALUES ('caa52211-ddca-40d1-ac14-4b3d84ba256b', 'd1136967-f856-4199-bd97-557cc9603ce4', 'email_verification', 'html', '["customer_name", "customer_first_name", "verification_code", "store_name", "store_url", "current_year"]', 'true', '2', 'false', '{}', '2025-11-03 23:14:30.679+00', '2025-11-05 19:00:58.234+00', 'true', 'Verify your email - {{store_name}}', null, '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            </div>'), ('c69316ab-7e8c-4590-850b-0f720c505d02', 'd1136967-f856-4199-bd97-557cc9603ce4', 'signup_email', 'both', '[{"key": "{{customer_name}}"}, {"key": "{{customer_first_name}}"}, {"key": "{{store_name}}"}, {"key": "{{store_url}}"}, {"key": "{{login_url}}"}, {"key": "{{current_year}}"}]', 'true', '1', 'false', '{}', '2025-10-31 21:21:14.762+00', '2025-11-05 19:00:58.234+00', 'true', 'Welcome to {{store_name}}!', 'Hi {{customer_first_name}},
...
{{email_footer}}'), ('07958749-5770-4838-87e1-b860ee355fb7', 'd1136967-f856-4199-bd97-557cc9603ce4', 'email_header', 'html', '["store_name", "store_logo_url"]', 'true', '100', 'false', '{}', '2025-11-05 17:45:19.314+00', '2025-11-05 19:01:56.141+00', 'true', 'Email Header Template', null, '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            </div>'), ('f67ae526-c1ab-45ab-bbd5-5b7b353644d9', 'd1136967-f856-4199-bd97-557cc9603ce4', 'email_footer', 'html', '["store_name", "store_url", "contact_email", "store_address", "store_city", "store_state", "store_postal_code", "current_year", "unsubscribe_url"]', 'true', '101', 'false', '{}', '2025-11-05 17:45:19.314+00', '2025-11-05 19:01:56.141+00', 'true', 'Email Footer Template', null, '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
('a1b2c3d4-e5f6-4789-abcd-111111111111', 'd1136967-f856-4199-bd97-557cc9603ce4', 'stock_issue_customer', 'both', '["customer_first_name", "order_number", "store_name", "store_url", "items_list"]', 'true', '25', 'false', '{}', '2025-11-26 10:00:00.000+00', '2025-11-26 10:00:00.000+00', 'true', 'Update on your order #{{order_number}} - {{store_name}}', 'Hi {{customer_first_name}},
...
{{email_footer}}'),
('a1b2c3d4-e5f6-4789-abcd-222222222222', 'd1136967-f856-4199-bd97-557cc9603ce4', 'stock_issue_admin', 'both', '["order_number", "order_id", "customer_email", "customer_name", "items_list", "store_name", "admin_url"]', 'true', '26', 'false', '{}', '2025-11-26 10:00:00.000+00', '2025-11-26 10:00:00.000+00', 'true', 'ACTION REQUIRED: Stock issue on order #{{order_number}}', 'Stock Issue Alert - Order #{{order_number}}
...
{{email_footer}}'),
('a1b2c3d4-e5f6-4789-abcd-333333333333', 'd1136967-f856-4199-bd97-557cc9603ce4', 'stock_issue_refunded', 'both', '["customer_first_name", "order_number", "store_name", "store_url", "refund_amount", "currency"]', 'true', '27', 'false', '{}', '2025-11-26 10:00:00.000+00', '2025-11-26 10:00:00.000+00', 'true', 'Your order #{{order_number}} has been refunded - {{store_name}}', 'Hi {{customer_first_name}},
...
('a1b2c3d4-e5f6-4789-abcd-444444444444', 'd1136967-f856-4199-bd97-557cc9603ce4', 'password_reset', 'both', '["customer_first_name", "customer_name", "reset_url", "reset_link", "store_name", "store_url", "current_year", "expiry_hours"]', 'true', '28', 'false', '{}', '2025-11-28 10:00:00.000+00', '2025-11-28 10:00:00.000+00', 'true', 'Reset your password - {{store_name}}', 'Hi {{customer_first_name}},
...
('a1b2c3d4-e5f6-4789-abcd-555555555555', 'd1136967-f856-4199-bd97-557cc9603ce4', 'password_reset_confirmation', 'both', '["customer_first_name", "customer_name", "store_name", "store_url", "login_url", "current_year"]', 'true', '29', 'false', '{}', '2025-11-28 10:00:00.000+00', '2025-11-28 10:00:00.000+00', 'true', 'Your password has been reset - {{store_name}}', 'Hi {{customer_first_name}},
...
INSERT INTO "public"."pdf_templates" ("id", "store_id", "identifier", "name", "template_type", "default_html_template", "is_active", "is_system", "variables", "settings", "sort_order", "created_at", "updated_at") VALUES ('0e4dd1d6-5b96-48f6-8f5b-df3ad79a39c6', 'd1136967-f856-4199-bd97-557cc9603ce4', 'shipment_pdf', 'Shipment/Packing Slip PDF', 'shipment', '<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  <style>
...
VALUES
  ...
  ('34dfa5d3-f709-4c54-bad8-0bd9a8ae3dc4', 'DHL', '', true, 'flat_rate', '7.00', '0.00', '[]'::jsonb, '[]'::jsonb, 'all', '[]'::jsonb, 1, 7, '157d4590-49bf-4b0b-bd77-abe131909528', 0, '2025-07-27T17:36:59.081Z', '2025-10-25T21:31:17.657Z', '{"en":{"name":"DHL-en","description":"dddd"},"nl":{"name":"dhl-nl","description":""}}'::jsonb, '{"skus":[],"categories":["702e7f39-e6f0-43f3-9ed1-f704c2c656fb"],"attribute_sets":[],"attribute_conditions":[]}'::jsonb)
ON CONFLICT DO NOTHING;
...
VALUES
  ...
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'checkout.login_required', 'en', 'Login Required', 'checkout', '2025-11-28T12:00:00.000Z', '2025-11-28T12:00:00.000Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'checkout.login_required_description', 'en', 'Please login or create an account to complete your purchase', 'checkout', '2025-11-28T12:00:00.000Z', '2025-11-28T12:00:00.000Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ('c3d4e5f6-a7b8-9012-cdef-123456789012', 'checkout.login_to_checkout', 'en', 'Login to Checkout', 'checkout', '2025-11-28T12:00:00.000Z', '2025-11-28T12:00:00.000Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ...
  ('f61032bc-fbd8-41ca-9120-d4e51b1ed2f9', 'common.sort_by', 'en', 'Sort By', 'sort_by', '2025-11-07T18:34:17.198Z', '2025-11-07T18:34:17.198Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ...
  ('5af06df4-eda6-4091-b259-853a14f4f9a6', 'product.out_of_stock', 'en', 'Out of Stock', 'product', '2025-11-07T18:34:17.198Z', '2025-11-07T18:34:17.198Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ...
  ('b0ef31ad-6b27-4edb-a1c1-6a73abad0ef1', 'cart.cart_empty_message', 'en', 'Looks like you haven''t added anything to your cart yet.', 'common', '2025-11-07T18:34:17.198Z', '2025-11-07T18:34:17.198Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ...
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'category.no_products_match', 'en', 'No products match your filters', 'category', '2025-11-07T18:34:17.198Z', '2025-11-07T18:34:17.198Z', 'system', '00000000-0000-0000-0000-000000000000'),
  ('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'category.try_different_filters', 'en', 'Try adjusting your filters or clearing some selections to see more products.', 'category', '2025-11-07T18:34:17.198Z', '2025-11-07T18:34:17.198Z', 'system', '00000000-0000-0000-0000-000000000000'),
