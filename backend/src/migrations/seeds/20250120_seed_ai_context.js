...
- \`renderOrderConfirmation(config, context)\``,
        category: 'core',
        tags: ['api', 'reference', 'hooks', 'methods'],
        priority: 90,
        mode: 'all',
        is_active: true,
        created_at: now,
...
module.exports = WelcomeBannerPlugin;`,
        files: [],
        features: ['HTML rendering', 'Configuration support', 'Context access'],
        use_cases: ['Simple homepage banners', 'Announcements', 'Marketing messages'],
        tags: ['simple', 'marketing', 'homepage', 'beginner'],
        is_template: true,
        is_active: true,
        rating: 4.5,
        created_at: now,
  ...
  await sequelize.getQueryInterface().addIndex('my_plugin_data', ['store_id']);
        ...
        tags: ['database', 'migration', 'sequelize', 'table'],
        is_active: true,
        created_at: now,
        updated_at: now
      },
  ...
  return router;
        ...
        language: 'javascript',
        framework: 'express',
        parameters: ['route_paths', 'handlers'],
        example_usage: 'Use in the registerRoutes() method',
        tags: ['api', 'routes', 'express', 'endpoints'],
        is_active: true,
        created_at: now,
        updated_at: now
      },
...
renderHomepageHeader(config, context) {
  ...
  \`;
        ...
        tags: ['security', 'xss', 'html', 'escaping'],
        is_active: true,
        created_at: now,
        updated_at: now
      }
