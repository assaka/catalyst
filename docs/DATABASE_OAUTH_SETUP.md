...
- ✅ Access to your production domain (e.g., `https://catalyst-pearl.vercel.app`)
...
| Field | Value |
|-------|-------|
| **Application Name** | `Catalyst Platform` (or your platform name) |
| **Redirect URI** | `https://catalyst-pearl.vercel.app/oauth/neon/callback` |
| **Description** | `Database integration for Catalyst e-commerce platform` |
...
| Field | Value |
|-------|-------|
| **Application Name** | `Catalyst Platform` |
| **Homepage URL** | `https://catalyst-pearl.vercel.app` |
| **Authorization Callback URL** | `https://catalyst-pearl.vercel.app/oauth/planetscale/callback` |
| **Description** | `Database integration for Catalyst stores` |
| **Application Logo** | (Optional) Upload your logo |
...
2. Sign in to your account
3. Navigate to your **backend service** (e.g., `catalyst-backend`)
...
Value: https://catalyst-pearl.vercel.app/oauth/neon/callback
...
Value: https://catalyst-pearl.vercel.app/oauth/planetscale/callback
       ↑ Use your actual production domain
```
...
1. Go to your platform: `https://catalyst-pearl.vercel.app`
...
NEON_REDIRECT_URI=https://catalyst-pearl.vercel.app/oauth/neon/callback
...
PLANETSCALE_REDIRECT_URI=https://catalyst-pearl.vercel.app/oauth/planetscale/callback
```
...
3. Ensure they match EXACTLY:
   ```
   Registered:  https://catalyst-pearl.vercel.app/oauth/neon/callback
   Render env:  https://catalyst-pearl.vercel.app/oauth/neon/callback
   ✓ MATCH
