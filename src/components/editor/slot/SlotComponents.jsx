...
export function CategorySortingSlot({ data, content }) {
  return (
    <div className="flex justify-between items-center mb-4">
    ...
    <nav className="text-sm text-gray-500 mb-4">
      {content ? (
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-gray-900">{data?.category?.name || 'Category'}</span>
        </div>
      )}
    </nav>
  );
...
export function CategoryPaginationSlot({ data, content }) {
  return (
    <div className="flex justify-center items-center space-x-2 mt-8">
      <button className="px-3 py-1 border rounded hover:bg-gray-100">&laquo;</button>
      <button className="px-3 py-1 border rounded bg-blue-600 text-white">1</button>
      <button className="px-3 py-1 border rounded hover:bg-gray-100">2</button>
      <button className="px-3 py-1 border rounded hover:bg-gray-100">3</button>
      <button className="px-3 py-1 border rounded hover:bg-gray-100">&raquo;</button>
    </div>
  );
}