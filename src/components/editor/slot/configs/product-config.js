...
export const productConfig = {
  ...
  slots: {
    ...
    add_to_cart_button: {
      ...
      type: 'button',
      content: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 mr-2"><circle cx="8" cy="21" r="1"></circle><circle cx="19" cy="21" r="1"></circle><path d="m2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43h-15.44"></path></svg> {{t "product.add_to_cart"}}`,
      ...
      metadata: {
        ...
        outOfStockContent: `<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"></path></svg> {{t "product.out_of_stock"}}`
      }
    },
            ...
            {{#each tabs}}
              <div class="border border-gray-200 rounded-lg" data-accordion-item="{{@index}}">
                ...
                <button
                  ...
                  <span class="font-medium" style="font-size: {{settings.theme.product_tabs_title_size}}; color: #2563eb;">{{this.name}}</span>
                  <svg
