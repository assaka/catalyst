...
export const productConfig = {
  ...
  slots: {
    ...
    main_image: {
      ...
      parentClassName: '{{#if (eq settings.product_gallery_layout "horizontal")}}order-1{{else}}{{#if (eq settings.vertical_gallery_position "right")}}order-first{{else}}order-last{{/if}}{{/if}} /* CACHE_TEST_2025_09_29_12_32 */',
      styles: {},
    ...
    thumbnail_gallery: {
      ...
      parentClassName: '{{#if (eq settings.product_gallery_layout "horizontal")}}order-2{{else}}{{#if (eq settings.vertical_gallery_position "right")}}order-last{{else}}order-first{{/if}}{{/if}} /* CACHE_TEST_THUMBNAILS_2025_09_29_12_32 */',
      styles: {},
      parentId: 'gallery_container',
      position: { col: 1, row: 1 },
      layout: 'flex',
