...
export const productConfig = {
  ...
  slots: {
    ...
    main_image: {
      ...
      parentClassName: '{{#if (eq settings.product_gallery_layout "horizontal")}}order-1{{/if}}{{#if (eq settings.product_gallery_layout "vertical")}}{{#if (eq settings.vertical_gallery_position "right")}}order-first{{/if}}{{#if (eq settings.vertical_gallery_position "left")}}order-last{{/if}}{{/if}}',
      styles: {},
    ...
    thumbnail_gallery: {
      ...
      parentClassName: '{{#if (eq settings.vertical_gallery_position "right")}}order-last{{/if}}{{#if (eq settings.vertical_gallery_position "left")}}order-first{{/if}}{{#if (eq settings.product_gallery_layout "horizontal")}}order-2{{/if}}',
      styles: {},
      parentId: 'gallery_container',
      position: { col: 1, row: 1 },
      layout: 'flex',
