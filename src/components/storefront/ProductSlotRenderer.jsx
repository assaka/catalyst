...
export function ProductSlotRenderer({
  ...
  const renderSlotContent = (slot) => {
    ...
    if (type === 'component') {
      ...
      if (componentName === 'ProductBreadcrumbsSlot') {
        return (
          <div className={className} style={styles}>
      ...
      // ProductGallerySlot Component
      if (componentName === 'ProductGallerySlot') {
      ...
      // ProductInfoSlot Component
      if (componentName === 'ProductInfoSlot') {
        if (!product) return null;
      ...
      // ProductOptionsSlot Component
      if (componentName === 'ProductOptionsSlot') {
        return (
          <div className={className} style={styles}>
      ...
      // ProductTabsSlot Component
      if (componentName === 'ProductTabsSlot') {
        if (!productTabs || productTabs.length === 0) return null;
      ...
      // ProductRecommendationsSlot Component
      if (componentName === 'ProductRecommendationsSlot') {
        if (!relatedProducts || relatedProducts.length === 0) return null;
