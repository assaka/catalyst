        ...
        return (
          <Card>
              ...
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Switch
                      checked={seoSettings.enable_hreflang}
                      onCheckedChange={(checked) => setSeoSettings(prev => ({ ...prev, enable_hreflang: checked }))}
                    />
                    <Label className="text-sm font-normal">Enable hreflang tags</Label>
                  </div>
                </div>
                {seoSettings.enable_hreflang && (
            ...
            <CardContent>
              ...
              {!seoSettings.enable_hreflang && (
                <p className="text-gray-600">Enable hreflang tags to configure language and region targeting for search engines.</p>
              )}
            </CardContent>
          </Card>
        );
