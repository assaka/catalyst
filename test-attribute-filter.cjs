...
(async () => {
  try {
    ...
    console.log('\n🚨 The issue might be:');
    console.log('1. Attributes are not being loaded at all in the frontend');
    console.log('2. Attribute set selection is not working properly');
    console.log('3. The filtering logic excludes too many attributes');
    console.log('4. The data structure changed after recent attribute option fixes');
